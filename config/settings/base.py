...
PRESTASHOP_HOST = os.getenv("PRESTASHOP_HOST", "")
...
_accepted_raw = os.getenv("PRESTASHOP_ORDER_STATE_PAYMENT_ACCEPTED", "2")
PRESTASHOP_ORDER_STATE_PAYMENT_ACCEPTED = {
    int(s.strip()) for s in _accepted_raw.split(",") if s.strip()
}
PRESTASHOP_SYNC_TEXTURE_IMAGES = os.getenv("PRESTASHOP_SYNC_TEXTURE_IMAGES", "false").lower() in (
    "true",
    "1",
    "yes",
)  # noqa:E501
